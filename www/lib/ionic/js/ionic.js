        ...
        case ionic.Gestures.EVENT_MOVE:
          ...
          if(ionic.Gestures.detection.current.name != this.name) {
            ...
            if (inst.options.correct_for_drag_min_distance) {
              ...
              // It might be useful to saveToStorage the original start point somewhere
...
ionic.views.Scroll = ionic.views.View.inherit({
  ...
  */
  ...
  __initEventHandlers: function() {
    ...
    // saveToStorage height when scroll view is shrunk so we don't need to reflow
...
(function () {
    ...
    var Swiper = function (container, params, _scope, $compile) {
        ...
        s.controller = {
            ...
            //xxx: for now i will just saveToStorage one spline function to to
